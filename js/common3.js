...
$(function(){
    ...
    rightNav += "<hr>";
    rightNav += "<li class='qrBtn'><a href='http://www.qijishow.com/Brand/Brand72/index.htm' target='_blank'>微信公众号</a></li>";
...
function scrollPlus()
{
    ...
    function make_boxes()
    {
        if (!b)
        {
            ...
            b.setAttribute("style", "width:21px;background:url(http://www.qijishow.com/down/assets/images/snav_icon.png) 15px 10px no-repeat rgb(47, 53, 76);min-height:30px;text-align:center;border-top-left-radius: 100px;padding: 6px 8px 0px 17px;border-bottom-left-radius: 100px;position: fixed; top: -40px; right: 0;overflow: hidden; z-index: 102400;font-family:Arial !important;cursor:n-resize;cursor:ns-resize;");
