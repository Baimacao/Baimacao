...
function getCSS()
{
        ...
        if (thehour<7)
            display = "http://www.qijishow.com/down/assets/css/night.css";
        else if (thehour<19)
...
function scrollPlus()
{
    ...
    function make_boxes()
    {
        if (!b)
        {
            ...
            b.setAttribute("style", "width:44px;background:url(http://www.qijishow.com/down/assets/images/snav_icon.png) 14px 10px no-repeat rgb(175, 175, 175);min-height:36px;text-align:center;border-top-left-radius: 100px;padding: 6px 8px 0px 17px;border-bottom-left-radius: 100px;position: fixed; top: -40px; right: 0;overflow: hidden; z-index: 102400;font-family:Arial !important;cursor:n-resize;cursor:ns-resize;");
