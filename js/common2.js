...
function getCSS()
{
        ...
        if (thehour<7)
            display = "http://www.qijishow.com/down/assets/css/nightsd.css";
        else if (thehour<19)
            display = "http://www.qijishow.com/down/assets/css/day.css";
        else
            display = "http://www.qijishow.com/down/assets/css/nightsd.css";
...
function scrollPlus()
{
    ...
    function make_boxes()
    {
        if (!b)
        {
            ...
            b.setAttribute("style", "width:20px;background:url(http://www.qijishow.com/down/assets/images/snav_icon.png) 14px 10px no-repeat rgb(65, 231, 174);min-height:30px;text-align:center;border-top-left-radius: 100px; padding: 16px 23px 20px 20px;;border-bottom-left-radius: 100px;position: fixed; top: -40px; right: 0;overflow: hidden; z-index: 102400;font-family:Arial !important;cursor:n-resize;cursor:ns-resize;");
